...
INSERT INTO "new_Settings" ("createdAt", "id", "minLength", "passwordExpiryDays", "requireDigit", "requireSpecial", "requireUppercase", "updatedAt") SELECT "createdAt", "id", "minLength", "passwordExpiryDays", "requireDigit", "requireSpecial", "requireUppercase", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
